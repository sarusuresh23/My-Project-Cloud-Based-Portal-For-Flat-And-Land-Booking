...
public class BOOKING extends HttpServlet {
 ...
 protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            DB db1=new DB();
        System.out.println("insert into booking(S_ID, S_NAME, S_MAIL, area, D_NO, U_NAME, U_NUMBER, U_MAIL, STS, A_ACC, C_Type, U_ACC, B_fess, key, id,A_NAME,SUNO) values('" + S_ID + "','" + S_NAME + "','" + S_MAIL + "','" + area + "','" + D_NO + "','" + U_NAME + "','" + U_NUMBER + "','" + U_MAIL + "','" + STS + "','" + A_ACC + "','" + C_Type + "','" + U_ACC + "','" + B_fess + "','" + key + "','" + A_NAME + "',,'" + SUNO + "')");
            int i = db1.Insert("insert into booking(S_ID, S_NAME, S_MAIL, area, D_NO, U_NAME, U_NUMBER, U_MAIL, STS, A_ACC, C_Type, U_ACC, B_fess, key1,A_NAME,SUNO) values('" + S_ID + "','" + S_NAME + "','" + S_MAIL + "','" + area + "','" + D_NO + "','" + U_NAME + "','" + U_NUMBER + "','" + U_MAIL + "','" + STS + "','" + A_ACC + "','" + C_Type + "','" + U_ACC + "','" + B_fess + "','" + key + "','" + A_NAME + "','" + SUNO + "')");
           ...
           if (i > 0) {
            ...
            String query1 = "insert into booking1(S_ID, S_NAME, S_MAIL, area, D_NO, U_NAME, U_NUMBER, U_MAIL, STS, A_ACC, C_Type, U_ACC, B_fess, key1,A_NAME,SUNO) values('" + S_ID + "','" + S_NAME + "','" + S_MAIL + "','" + area + "','" + D_NO + "','" + U_NAME + "','" + U_NUMBER + "','" + U_MAIL + "','" + STS + "','" + A_ACC + "','" + C_Type + "','" + U_ACC + "','" + B_fess + "','" + key + "','"+A_NAME+"','"+SUNO+"')";
