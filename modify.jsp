 ...
 <style>
  ...
  <div style="margin-top:15%;" class="container">
    ...
    <div class="container-fluid py-lg-5 py-md-4 py-sm-4 py-3">
        <center><h3>BUYER DETAILS</h3></center>
        <br>
        <br>
       <table border="1" align="center">
        ...
        <tr>
            ...
            <td><%=rs.getString("STS")%></td>
             <td><a href="request6.jsp?A_NAME=<%=rs.getString("A_NAME")%>">SOLD OUT</a></td>
             <td><a href="request9.jsp?S_ID=<%=rs.getString("S_ID")%>">SOLD OUT</a></td>
        </tr>
           <%
                   }
           %>
