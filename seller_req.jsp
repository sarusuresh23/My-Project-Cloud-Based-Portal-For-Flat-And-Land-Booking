...
<center>
  <div style="margin-top:15%;" class="container">
    ...
    <div class="container-fluid py-lg-5 py-md-4 py-sm-4 py-3">
        <center><h3>SELLER VERIFICATION</h3></center>
        <br>
        <br>
       <table>
           <tr>
               ...
               <%
                   DB db1=new DB();
                   String query="select * from sellerregister where sts='NO'";
        ...
        <tr>
            <td><img src="servlet_4.jsp?name=<%=rs.getInt("S_ID")%> " style="width: 250px; height: 180px;"></td> 
            <td><%=rs.getString("A_Name")%></td>
            <td><%=rs.getString("username")%></td>
            <td><%=rs.getString("email")%></td>
            <td><%=rs.getString("mobile_no")%></td>
            <td><%=rs.getString("sts")%></td>
            <td><a href="request1.jsp?username=<%=rs.getString("username")%>">APPROVED</a>/<a href="request2.jsp?username=<%=rs.getString("username")%>">REJECTED</a></td>
