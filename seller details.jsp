<%-- 
    ...
    Created on : May 12, 2023, 12:52:06 PM
    Author     : elangovan
--%>
    ...
    <div class="container-fluid py-lg-5 py-md-4 py-sm-4 py-3">
       ...
       <table border="1" align="center">
           <tr>
               ...
               <%
                   DB db1=new DB();
                   String query="select * from sellerregister where sts='Approved'";
        ...
        <tr>
            ...
            <td><a href="request4.jsp?username=<%=rs.getString("username")%>">BLOCK</a></td>
