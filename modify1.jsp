 ...
 <style>
  ...
  <div style="margin-top:15%;" class="container">
    ...
    <div class="container-fluid py-lg-5 py-md-4 py-sm-4 py-3">
        <center><h3>FLAT/HOSE BOOKING DETAILS</h3></center>
        <br>
        <br>
       <table border="1" align="center">
        ...
        <tr>
            ...
            <td><a href="request7.jsp?A_NAME=<%=rs.getString("A_NAME")%>">SOLD OUT</a></td>
            <td><a href="request8.jsp?S_ID=<%=rs.getString("S_ID")%>">SOLD OUT</a></td>
        </tr>
           <%
                   }
           %>
