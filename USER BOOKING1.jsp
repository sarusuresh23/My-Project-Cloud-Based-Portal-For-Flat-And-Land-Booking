<%-- 
    Document   : USER BOOKING1
    Created on : Apr 5, 2023, 6:39:40 PM
    Author     : ELANGOVAN
--%>
...
<body>
  ...
  <div style="margin-top:15%;" class="container">
    ...
    <div class="container-fluid py-lg-5 py-md-4 py-sm-4 py-3">
        <center><h3>FLAT/HOUSE BOOKING DETAILS</h3></center>
        <br>
        <br>
       <table border="1" align="center">
        ...
        <tr>
            ...
            <td><a style="color: white" href="ADMIN_MAIL.jsp?username=<%=rs.getString("S_MAIL")%>">SENT MAIL</a></td>
