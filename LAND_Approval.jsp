            ...
            <div class="row">
                ...
                <section class="stats-count py-lg-4 py-md-3 py-sm-3 py-3">
                    <div class="container-fluid py-lg-5 py-md-4 py-sm-4 py-3">
                        ...
                        <center><h3>LAND VERIFICATION</h3></center>
                        <br>
                        <br>
                        <table>
                            <tr>
                            ...
                            <%
                                DB db1 = new DB();
                                String query = "select * from upload where sts='NO'";
                            ...
                            <tr>
                                ...
                                <td><img src="servlet_3.jsp?name=<%=rs.getInt("S_ID")%> " style="width: 250px; height: 120px;"></td> 
                                ...
                                <td><a style="color: white" href="https://tnreginet.gov.in/portal/webHP?requestType=ApplicationRH&actionVal=homePage&screenId=114&UserLocaleID=en&_csrf=8f698b32-bb1b-4f4d-9132-500d1605db48">CLICK HERE</a></td>
                                <td><a style="color: white" href="landrequest.jsp?D_NO=<%=rs.getString("D_NO")%>">Approved</a>/<a style="color: white" href="landrequest1.jsp?D_NO=<%=rs.getString("D_NO")%>">Rejected</a></td>
                                <td><a style="color: white" href="charges.jsp?S_ID=<%=rs.getString("S_ID")%>">BOOKING CHARGE</a></td>
                            </tr>
                            <%
                                }
                            %>
