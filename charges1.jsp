                            ...
                            <table border="3">
                                ...
                                <%
                                      ...
                                      while(rs1.next())
                                      {
                                        ...
                                        %>
                                 <tr><td>Id</td><td>:</td><td><input type="text" name="S_ID" id="S_ID" value="<%=rs1.getInt("S_ID")%>" readonly></td></tr>
                                 <tr><td>Booking Charge</td><td>:</td><td><input type="text" name="fess" value="<%=rs1.getInt("fess")%>" id="fess" required></td></tr>
                                        <%
                                      }
